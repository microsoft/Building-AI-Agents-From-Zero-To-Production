...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-15T14:42:50+00:00",
...
ఈ కోర్సులో AI ఏజెంట్లను నిర్మించడం మరియు డిప్లాయ్ చేయడం యొక్క ప్రాథమికాంశాలను కవర్ చేసే పాఠాలు ఉన్నాయి.
...
ప్రతి పాఠానికి దాని స్వంత కోడ్ నమూనా ఉంటుంది, మీరు స్థానికంగా నడపవచ్చు. మీరు [ఈ రిపోను ఫోర్క్](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork) చేసుకుని మీ స్వంత కాపీని సృష్టించవచ్చు.
...
| [ఏజెంట్ డిప్లాయ్‌మెంట్](./lesson-4-agent-deployment/README.md)   | హోస్టెడ్ ఏజెంట్లు మరియు OpenAI Chatkit ఉపయోగించి, AI ఏజెంట్‌ను ప్రొడక్షన్‌లో ఎలా డిప్లాయ్ చేయాలో చూడండి.       |

## సహకారం

ఈ ప్రాజెక్ట్ సహకారాలు మరియు సూచనలను స్వాగతిస్తుంది. చాలా సహకారాలకు మీరు ఒక
కాంట్రిబ్యూటర్ లైసెన్స్ అగ్రిమెంట్ (CLA) కు అంగీకరించాలి, ఇది మీరు మీ సహకారాన్ని ఉపయోగించడానికి హక్కు కలిగి ఉన్నారని మరియు నిజంగా హక్కులు ఇస్తున్నారని ప్రకటిస్తుంది. వివరాలకు, <https://cla.opensource.microsoft.com> ను సందర్శించండి.
...
Microsoft ట్రేడ్మార్కులు లేదా లోగోలను ఈ ప్రాజెక్ట్ యొక్క సవరించిన సంస్కరణల్లో ఉపయోగించడం Microsoft స్పాన్సర్షిప్ కలిగినట్లు గందరగోళం కలిగించకూడదు.
