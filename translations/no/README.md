...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-12T17:03:50+00:00",
...
![Bygge AI-agenter fra null til produksjon](../../translated_images/repo-thumbnail.083b24afed61b6dd27a7fc53798bebe9edf688a41031163a1fca9f61c64d63ec.no.png)

## Et kurs som lærer deg det grunnleggende i AI-agentutviklingslivssyklusen
...
| [Agent Development](./lesson-2-agent-development/README.md)  | Bruke Microsoft Agent Framework (MAF) for å lage 3 agenter som hjelper nye utviklere med onboarding.       |
| [Agent Evaluations](./lesson-3-agent-evals/README.md)  | Bruke Microsoft Foundry for å finne ut hvor godt AI-agentene våre presterer og hvordan forbedre dem. |
| [Agent Deployment](./lesson-4-agent-deployment/README.md)   | Bruke Hosted Agents og OpenAI Chatkit for å se hvordan man distribuerer en AI-agent i produksjon.       |
