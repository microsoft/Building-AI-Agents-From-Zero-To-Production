...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-12T16:53:04+00:00",
...
یہ کورس AI ایجنٹس کی تعمیر اور تعیناتی کے بنیادی اصولوں پر مشتمل اسباق پر مشتمل ہے۔

ہر سبق پچھلے سبق پر مبنی ہے، اس لیے ہم تجویز کرتے ہیں کہ آپ ابتدا سے شروع کریں اور آخر تک کام کریں۔
...
ہر سبق کے ساتھ اپنا کوڈ نمونہ ہوتا ہے جسے آپ مقامی طور پر چلا سکتے ہیں۔ آپ [اس ریپو کو فورک کریں](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork) تاکہ اپنی کاپی بنا سکیں۔
...
Contributor License Agreement (CLA) پر اتفاق کرنا ہوگا جو یہ ظاہر کرتا ہے کہ آپ کے پاس اپنے تعاون کے حقوق دینے کا حق ہے اور آپ واقعی ہمیں یہ حقوق دے رہے ہیں۔ تفصیلات کے لیے ملاحظہ کریں <https://cla.opensource.microsoft.com>۔

جب آپ پل ریکویسٹ جمع کرواتے ہیں، تو CLA بوٹ خود بخود طے کرے گا کہ آیا آپ کو CLA فراہم کرنے کی ضرورت ہے اور PR کو مناسب طریقے سے نشان زد کرے گا (مثلاً، اسٹیٹس چیک، تبصرہ)۔ بس بوٹ کی ہدایات پر عمل کریں۔ آپ کو یہ صرف ایک بار تمام ریپوز میں کرنا ہوگا جو ہمارے CLA استعمال کرتے ہیں۔
...
[Microsoft's Trademark & Brand Guidelines](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) کے تابع ہے اور ان کی پیروی کرنا ضروری ہے۔
Microsoft کے تجارتی نشان یا لوگوز کا اس پروجیکٹ کے ترمیم شدہ ورژنز میں استعمال الجھن پیدا نہیں کرنا چاہیے اور نہ ہی Microsoft کی سرپرستی کا تاثر دینا چاہیے۔
