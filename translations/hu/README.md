...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-18T14:38:52+00:00",
...
| [Ügynök telepítés](./lesson-4-agent-deployment/README.md)   | A Hosted Agents és az OpenAI Chatkit használatával nézd meg, hogyan lehet AI ügynököt élesben telepíteni.       |

## Közreműködés

Ez a projekt szívesen fogad hozzájárulásokat és javaslatokat. A legtöbb hozzájáruláshoz el kell fogadnod egy
Contributor License Agreement (CLA) megállapodást, amely kimondja, hogy jogod van a hozzájárulásod használatára, és ténylegesen megadod nekünk ezt a jogot. Részletekért látogass el a <https://cla.opensource.microsoft.com> oldalra.
