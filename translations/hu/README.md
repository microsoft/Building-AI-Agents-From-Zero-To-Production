...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T14:03:04+00:00",
...
Ha elakadsz vagy kérdésed van az AI ügynökök építésével kapcsolatban, csatlakozz dedikált Discord csatornánkhoz a [Microsoft Foundry Discord](https://discord.gg/Kuaw3ktsu6) szerveren.
...
| **Lecke**         | **Leírás**                                                                                  |
|--------------------|--------------------------------------------------------------------------------------------------|
| [Ügynök tervezés](./lesson-1-agent-design/README.md)       | Bevezetés a "Fejlesztői Bevezetés" ügynök használati esetbe és az eredményes ügynökök tervezésébe  |
...
| [Ügynök telepítés](./lesson-4-agent-deployment/README.md)   | A Hosted Agents és OpenAI Chatkit használatával nézd meg, hogyan lehet AI ügynököt termelésbe telepíteni.       |

## Közreműködés

Ez a projekt szívesen fogad hozzájárulásokat és javaslatokat. A legtöbb hozzájáruláshoz el kell fogadnod egy
Contributor License Agreement (CLA) megállapodást, amely kijelenti, hogy jogod van, és ténylegesen megadod nekünk
...
és megfelelően jelöli a PR-t (pl. státusz ellenőrzés, komment). Egyszerűen kövesd a bot utasításait.
Ezt csak egyszer kell megtenned az összes CLA-t használó repóban.

Ez a projekt elfogadta a [Microsoft Open Source Magatartási Kódexét](https://opensource.microsoft.com/codeofconduct/).
