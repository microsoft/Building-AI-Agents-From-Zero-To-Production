...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T10:40:07+00:00",
...
[![Заявки за изтегляне в GitHub](https://img.shields.io/github/issues-pr/microsoft/Building-AI-Agents-From-Zero-To-Production.svg)](https://GitHub.com/microsoft/Building-AI-Agents-From-Zero-To-Production/pulls/?WT.mc_id=academic-105485-koreyst)
...
| [Внедряване на агент](./lesson-4-agent-deployment/README.md)   | Използвайки хоствани агенти и OpenAI Chatkit, вижте как да внедрите AI агент в продукция.       |
