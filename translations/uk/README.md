...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T10:47:29+00:00",
...
![Створення AI агентів від нуля до виробництва](../../translated_images/repo-thumbnail.083b24afed61b6dd27a7fc53798bebe9edf688a41031163a1fca9f61c64d63ec.uk.png)
...
Кожен урок базується на попередньому, тому ми рекомендуємо починати з початку і проходити курс до кінця.

Якщо ви хочете дізнатися більше про теми AI агентів, можете ознайомитися з курсом [AI Agents For Beginners](https://aka.ms/ai-agents-beginners).

### Познайомтеся з іншими учнями, отримайте відповіді на свої питання

Якщо у вас виникли труднощі або є питання щодо створення AI агентів, приєднуйтесь до нашого спеціального Discord-каналу в [Microsoft Foundry Discord](https://discord.gg/Kuaw3ktsu6).
...
| **Урок**           | **Опис**                                                                                         |
|--------------------|-------------------------------------------------------------------------------------------------|
| [Проєктування агента](./lesson-1-agent-design/README.md)       | Вступ до нашого кейсу використання агента "Вступ для розробника" та як проєктувати ефективних агентів  |
| [Розробка агента](./lesson-2-agent-development/README.md)  | Використовуючи Microsoft Agent Framework (MAF), створіть 3 агентів, щоб допомогти новим розробникам адаптуватися.       |
| [Оцінка агента](./lesson-3-agent-evals/README.md)  | Використовуючи Microsoft Foundry, дізнайтеся, наскільки добре працюють наші AI агенти та як їх покращити. |
| [Розгортання агента](./lesson-4-agent-deployment/README.md)   | Використовуючи Hosted Agents та OpenAI Chatkit, дізнайтеся, як розгорнути AI агента у виробництво.       |
...
Для отримання додаткової інформації дивіться [Поширені запитання щодо Кодексу поведінки](https://opensource.microsoft.com/codeofconduct/faq/) або
