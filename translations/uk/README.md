...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T14:10:15+00:00",
...
| **Урок**           | **Опис**                                                                                         |
|--------------------|--------------------------------------------------------------------------------------------------|
| [Проєктування агента](./lesson-1-agent-design/README.md)       | Вступ до нашого кейсу використання "Впровадження розробника" та як проектувати ефективних агентів  |
| [Розробка агента](./lesson-2-agent-development/README.md)  | Використовуючи Microsoft Agent Framework (MAF), створіть 3 агентів, щоб допомогти новим розробникам впровадитися.       |
| [Оцінка агента](./lesson-3-agent-evals/README.md)  | Використовуючи Microsoft Foundry, дізнайтеся, наскільки добре працюють наші AI агенти і як їх покращити. |
