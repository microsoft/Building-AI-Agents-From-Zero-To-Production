...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-15T14:29:30+00:00",
...
![Membangun Agen AI dari Nol hingga Produksi](../../translated_images/repo-thumbnail.083b24afed61b6dd27a7fc53798bebe9edf688a41031163a1fca9f61c64d63ec.id.png)
...
Setiap pelajaran membangun dari pelajaran sebelumnya, jadi kami sarankan memulai dari awal dan melanjutkan hingga akhir.
...
Setiap Pelajaran memiliki contoh kode sendiri yang dapat Anda jalankan secara lokal. Anda dapat [fork repo ini](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork) untuk membuat salinan Anda sendiri.
...
Pastikan Anda memiliki akses ke layanan ini sebelum memulai.

Pilihan lebih lanjut terkait hosting model dan layanan akan segera hadir.

## 🗃️ Pelajaran

| **Pelajaran**         | **Deskripsi**                                                                                  |
|-----------------------|------------------------------------------------------------------------------------------------|
| [Desain Agen](./lesson-1-agent-design/README.md)       | Pengenalan ke Kasus Penggunaan Agen "Developer Onboarding" kami dan cara merancang agen yang efektif  |
...
| [Penerapan Agen](./lesson-4-agent-deployment/README.md)   | Menggunakan Hosted Agents dan OpenAI Chatkit, lihat cara menerapkan Agen AI ke produksi.       |
...
Saat Anda mengirimkan permintaan tarik, bot CLA akan secara otomatis menentukan apakah Anda perlu memberikan
