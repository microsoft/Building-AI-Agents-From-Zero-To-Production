...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-24T23:04:16+00:00",
...
[![GitHub मुद्दे](https://img.shields.io/github/issues/microsoft/Building-AI-Agents-From-Zero-To-Production.svg)](https://GitHub.com/microsoft/Building-AI-Agents-From-Zero-To-Production/issues/?WT.mc_id=academic-105485-koreyst)
[![GitHub पुल अनुरोध](https://img.shields.io/github/issues-pr/microsoft/Building-AI-Agents-From-Zero-To-Production.svg)](https://GitHub.com/microsoft/Building-AI-Agents-From-Zero-To-Production/pulls/?WT.mc_id=academic-105485-koreyst)
...
[![Microsoft Foundry डिस्कॉर्ड](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/Kuaw3ktsu6)

## 🌱 आरंभ करें

यह कोर्स AI एजेंट्स के निर्माण और परिनियोजन के मूल सिद्धांतों को कवर करने वाले पाठ प्रदान करता है।

प्रत्येक पाठ पिछले पाठ पर आधारित होता है, इसलिए हम सुझाव देते हैं कि आप शुरुआत से शुरू करें और अंत तक क्रमशः आगे बढ़ें।

यदि आप AI एजेंट विषयों के बारे में और अधिक जानना चाहते हैं, तो आप [AI एजेंट्स शुरुआती कोर्स](https://aka.ms/ai-agents-beginners) देख सकते हैं।

### अन्य सीखने वालों से मिलें, अपने प्रश्नों के उत्तर पाएं

यदि आप फंस जाते हैं या AI एजेंट बनाने के बारे में कोई प्रश्न है, तो हमारे समर्पित डिस्कॉर्ड चैनल में शामिल हों: [Microsoft Foundry डिस्कॉर्ड](https://discord.gg/Kuaw3ktsu6).

### जिन चीज़ों की आपको आवश्यकता है

प्रत्येक पाठ के साथ उसका अपना कोड सैंपल है जिसे आप लोकली चला सकते हैं। आप अपनी कॉपी बनाने के लिए [इस रिपो को फोर्क करें](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork).
...
कृपया आरंभ करने से पहले सुनिश्चित करें कि आपके पास इन सेवाओं तक पहुँच है।
...
| **पाठ**         | **विवरण**                                                                                  |
|--------------------|--------------------------------------------------------------------------------------------------|
| [एजेंट डिजाइन](./lesson-1-agent-design/README.md)       | हमारे "डेवलपर ऑनबोर्डिंग" एजेंट उपयोग केस का परिचय और प्रभावी एजेंट कैसे डिज़ाइन करें  |
...
| [एजेंट मूल्यांकन](./lesson-3-agent-evals/README.md)  | Microsoft Foundry का उपयोग करके पता करें कि हमारे AI एजेंट कितनी अच्छी तरह प्रदर्शन कर रहे हैं और उन्हें कैसे सुधारें। |
| [एजेंट परिनियोजन](./lesson-4-agent-deployment/README.md)   | Hosted Agents और OpenAI Chatkit का उपयोग करके देखें कि AI एजेंट को उत्पादन में कैसे तैनात किया जाए।       |
...
यह प्रोजेक्ट योगदान और सुझावों का स्वागत करता है। अधिकांश योगदानों के लिए आपको एक Contributor License Agreement (CLA) से सहमति देनी होती है जिसमें आप घोषणा करते हैं कि आपके पास यह अधिकार है, और आप वास्तव में हमें अपने योगदान का उपयोग करने के अधिकार प्रदान करते हैं। विवरण के लिए देखें <https://cla.opensource.microsoft.com>.

जब आप एक पुल अनुरोध सबमिट करते हैं, तो एक CLA बॉट स्वचालित रूप से यह निर्धारित करेगा कि क्या आपको CLA प्रदान करने की आवश्यकता है और PR को उपयुक्त रूप से चिह्नित करेगा (उदा., स्थिति जांच, टिप्पणी)। बस बॉट द्वारा दिए गए निर्देशों का पालन करें। हमारे CLA का उपयोग करने वाले सभी रिपोज़ पर आपको यह केवल एक बार करना होगा।

यह प्रोजेक्ट [Microsoft ओपन सोर्स आचार संहिता](https://opensource.microsoft.com/codeofconduct/) अपना चुका है। अधिक जानकारी के लिए [आचार संहिता FAQ](https://opensource.microsoft.com/codeofconduct/faq/) देखें या किसी अतिरिक्त प्रश्न या टिप्पणी के लिए [opencode@microsoft.com](mailto:opencode@microsoft.com) से संपर्क करें।

## ट्रेडमार्क

इस प्रोजेक्ट में प्रोजेक्ट, उत्पाद, या सेवाओं के ट्रेडमार्क या लोगो हो सकते हैं। Microsoft के ट्रेडमार्क या लोगो का अधिकृत उपयोग [Microsoft के ट्रेडमार्क और ब्रांड दिशानिर्देश](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) के अधीन है और इसका पालन करना आवश्यक है। Microsoft के ट्रेडमार्क या लोगो का इस प्रोजेक्ट के संशोधित संस्करणों में उपयोग भ्रम पैदा नहीं करना चाहिए और न ही Microsoft की प्रायोजन का संकेत देना चाहिए। किसी तृतीय-पक्ष के ट्रेडमार्क या लोगो के किसी भी उपयोग पर उन तृतीय-पक्षों की नीतियाँ लागू होती हैं।

## सहायता प्राप्त करें

यदि आप अटक जाएँ या AI ऐप्स बनाने के बारे में कोई प्रश्न हों, तो जुड़ें:
...
अस्वीकरण:
यह दस्तावेज़ AI अनुवाद सेवा Co-op Translator (https://github.com/Azure/co-op-translator) का उपयोग करके अनुवादित किया गया है। जबकि हम सटीकता का प्रयास करते हैं, कृपया ध्यान दें कि स्वचालित अनुवादों में त्रुटियाँ या अशुद्धियाँ हो सकती हैं। मूल दस्तावेज़ इसकी मूल भाषा में ही आधिकारिक स्रोत माना जाना चाहिए। महत्वपूर्ण जानकारी के लिए, पेशेवर मानव अनुवाद की सलाह दी जाती है। इस अनुवाद के उपयोग से उत्पन्न किसी भी गलतफहमी या गलत व्याख्या के लिए हम उत्तरदायी नहीं हैं।
