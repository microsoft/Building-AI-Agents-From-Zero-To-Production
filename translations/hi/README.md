...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T11:36:17+00:00",
...
![Building AI Agents from Zero to Production](../../translated_images/repo-thumbnail.083b24afed61b6dd27a7fc53798bebe9edf688a41031163a1fca9f61c64d63ec.hi.png)
...
यदि आप AI एजेंट विषयों के बारे में और जानना चाहते हैं, तो आप [AI Agents For Beginners Course](https://aka.ms/ai-agents-beginners) देख सकते हैं।
...
| [एजेंट विकास](./lesson-2-agent-development/README.md)  | Microsoft Agent Framework (MAF) का उपयोग करके, नए डेवलपर्स को ऑनबोर्ड करने में मदद करने के लिए 3 एजेंट बनाएं।       |
| [एजेंट मूल्यांकन](./lesson-3-agent-evals/README.md)  | Microsoft Foundry का उपयोग करके, पता लगाएं कि हमारे AI एजेंट कितने अच्छे प्रदर्शन कर रहे हैं और उन्हें कैसे सुधारें। |
