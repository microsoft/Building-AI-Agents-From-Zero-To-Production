...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T10:25:46+00:00",
  "source_file": "README.md",
  "language_code": "he"
}
-->
# בניית סוכני בינה מלאכותית מאפס ועד לפרודקשן

![בניית סוכני בינה מלאכותית מאפס ועד לפרודקשן](../../translated_images/repo-thumbnail.083b24afed61b6dd27a7fc53798bebe9edf688a41031163a1fca9f61c64d63ec.he.png)
...
קורס זה כולל שיעורים המכסים את יסודות בניית והטמעת סוכני בינה מלאכותית.

כל שיעור בונה על הקודם, לכן מומלץ להתחיל מההתחלה ולהתקדם עד הסוף.
...
| [הערכות סוכן](./lesson-3-agent-evals/README.md)  | שימוש ב-Microsoft Foundry, גלה עד כמה הסוכנים שלנו מתפקדים ואיך לשפר אותם. |
| [פריסת סוכן](./lesson-4-agent-deployment/README.md)   | שימוש בסוכנים מאוחסנים ו-OpenAI Chatkit, ראה איך לפרוס סוכן בינה מלאכותית לפרודקשן.       |
...
הסכם רישיון תורם (CLA) המצהיר כי יש לך את הזכות, וכי אתה אכן מעניק לנו
...
CLA ויעטר את בקשת המשיכה בהתאם (למשל, בדיקת סטטוס, תגובה). פשוט עקוב אחר ההוראות
...
צור קשר בכתובת [opencode@microsoft.com](mailto:opencode@microsoft.com) עם שאלות או הערות נוספות.

## סימני מסחר

פרויקט זה עשוי להכיל סימני מסחר או לוגואים של פרויקטים, מוצרים או שירותים. שימוש מורשה בסימני המסחר או בלוגואים של מיקרוסופט כפוף ל
...
כל שימוש בסימני מסחר או בלוגואים של צדדים שלישיים כפוף למדיניות של אותם צדדים שלישיים.
