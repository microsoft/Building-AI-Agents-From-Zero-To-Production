...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T14:06:51+00:00",
...
| **Лекција**         | **Опис**                                                                                  |
|--------------------|--------------------------------------------------------------------------------------------------|
| [Дизајн агента](./lesson-1-agent-design/README.md)       | Увод у наш случај употребе "Увођење програмера" и како дизајнирати ефикасне агенте  |
| [Развој агента](./lesson-2-agent-development/README.md)  | Користећи Microsoft Agent Framework (MAF), направите 3 агента који помажу новим програмерима да се упознају са системом.       |
...
Употреба Microsoft заштитних знакова или логотипа у модификованим верзијама овог пројекта не сме изазивати конфузију или имплицирати спонзорство од стране Microsoft-а.
