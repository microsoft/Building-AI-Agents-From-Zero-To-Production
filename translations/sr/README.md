...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-24T23:55:25+00:00",
...
[![GitHub pull-захтеви](https://img.shields.io/github/issues-pr/microsoft/Building-AI-Agents-From-Zero-To-Production.svg)](https://GitHub.com/microsoft/Building-AI-Agents-From-Zero-To-Production/pulls/?WT.mc_id=academic-105485-koreyst)
...
Свака лекција надограђује претходну, па препоручујемо да почнете од почетка и идете редом до краја.

Ако желите да истражите више тема о AI агентима, можете погледати [Курс: AI агенти за почетнике](https://aka.ms/ai-agents-beginners).

### Упознајте друге полазнике, добијте одговоре на питања

Ако заглавите или имате било каквих питања у вези са изградњом AI агената, придружите се нашем посвећеном Discord каналу у [Microsoft Foundry Discord](https://discord.gg/Kuaw3ktsu6).

### Шта вам је потребно

Свака лекција има свој пример кода који можете покренути локално. Можете [форк-овати овај репозиторијум](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork) да направите своју копију.
...
Молимо уверите се да имате приступ овим услугама пре него што почнете.

Ускоро ће бити доступне додатне опције за хостовање модела и услуге.

## 🗃️ Лекције

| **Лекција**         | **Опис**                                                                                  |
|--------------------|--------------------------------------------------------------------------------------------------|
| [Дизајн агента](./lesson-1-agent-design/README.md)       | Увод у наш "Developer Onboarding" пример употребе агента и како дизајнирати ефикасне агенте  |
| [Развој агента](./lesson-2-agent-development/README.md)  | Користећи Microsoft Agent Framework (MAF), креирајте 3 агента који ће помоћи новим програмерима да се укључе.       |
| [Евалуација агената](./lesson-3-agent-evals/README.md)  | Користећи Microsoft Foundry, сазнајте колико добро наши AI агенти раде и како их побољшати. |
| [Распоређивање агената](./lesson-4-agent-deployment/README.md)   | Користећи Hosted Agents и OpenAI Chatkit, погледајте како распоредити AI агента у производњу.       |
...
Овај пројекат поздравља доприносе и предлоге.  Већина доприноса захтева да се сагласите са Уговором о лиценци сарадника (CLA) којим изjavљујете да имате право и да нам заправо дајете права да користимо ваш допринос. За детаље посетите <https://cla.opensource.microsoft.com>.

Када пошаљете a pull request, CLA бот ће аутоматски одредити да ли треба да доставите CLA и означити PR на одговарајући начин (нпр. провера статуса, коментар). Једноставно пратите упутства која пружи бот. Ово ћете морати да урадите само једном за све репозиторијуме који користе наш CLA.
...
контактирајте [opencode@microsoft.com](mailto:opencode@microsoft.com) са било каквим додатним питањима или коментарима.

## Заштитни знаци

Овај пројекат може садржати жигове или логотипе пројеката, производа или услуга. Овлашћена употреба Microsoft-ових жигова или логотипа подлеже и мора се придржавати
[Упутстава Microsoft-а за жигове и бренд](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Употреба Microsoft-ових жигова или логотипа у изменљивим верзијама овог пројекта не сме довести до забуне нити наговештавати да Microsoft стипендира пројекат.
Било каква употреба жигова или логотипа трећих страна подлеже правилима тих трећих страна.

## Добијање помоћи

Ако запнете или имате питања о креирању AI апликација, придружите се:

[![Discord за Microsoft Foundry](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/Kuaw3ktsu6)

Ако имате повратне информације о производу или приметите грешке током израде, посетите:
