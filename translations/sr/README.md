...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-18T14:42:09+00:00",
...
| [Развој агента](./lesson-2-agent-development/README.md)  | Коришћењем Microsoft Agent Framework (MAF), направите 3 агента који помажу новим програмерима да се укључе.       |
...
| [Деплој агената](./lesson-4-agent-deployment/README.md)   | Коришћењем Hosted Agents и OpenAI Chatkit, погледајте како да имплементирате AI агента у производњу.       |
...
Употреба Microsoft заштитних знакова или логотипа у модификованим верзијама овог пројекта не сме изазвати конфузију или имплицирати Microsoft спонзорство.
