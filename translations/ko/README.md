...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T13:44:09+00:00",
...
모델 호스팅 및 서비스에 관한 더 많은 옵션이 곧 제공될 예정입니다.
...
| [Agent Evaluations](./lesson-3-agent-evals/README.md)  | Microsoft Foundry를 사용하여 AI 에이전트의 성능 평가 및 개선 방법 알아보기                   |
| [Agent Deployment](./lesson-4-agent-deployment/README.md)   | Hosted Agents와 OpenAI Chatkit을 사용하여 AI 에이전트를 프로덕션에 배포하는 방법             |
...
공인 사용은 [Microsoft의 상표 및 브랜드 가이드라인](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general)을
준수해야 합니다.
