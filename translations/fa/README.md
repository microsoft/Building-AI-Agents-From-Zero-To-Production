...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T11:31:43+00:00",
...
هر درس نمونه کد مخصوص به خود را دارد که می‌توانید به صورت محلی اجرا کنید. می‌توانید [این مخزن را فورک کنید](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork) تا نسخه خود را بسازید.
